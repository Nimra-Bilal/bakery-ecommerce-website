  ...
  return (
    <div className="container my-5 p-4 bg-dark text-white rounded">
      ...
      <div className="d-flex text-center">
        <div className="flex-grow-1 py-3 border border-secondary bg-secondary text-white fw-semibold rounded-top" style={{ cursor: 'pointer' }}>
          Description
        </div>
        <div className="flex-grow-1 py-3 border border-secondary text-secondary fw-semibold" style={{ cursor: 'pointer' }}>
          Review (132)
        </div>
      </div>

      {/* Content Section */}
      <div className="border border-secondary p-4 bg-secondary-dark text-white rounded-bottom">
        {/* Description Section */}
        <div className="mb-4">
          <h2 className="text-danger mb-3">Description</h2>
          <p>
            Our bakery offers a delightful assortment of freshly baked goods, from classic breads to sweet pastries. We take pride in using only the finest ingredients, ensuring that each item is both delicious and satisfying. Whether you're craving a soft, warm loaf of sourdough or a delicate, buttery croissant, our bakery has something for every taste.
          </p>
          <p>
        ...
        {/* Review Section */}
        <div>
          <h2 className="text-danger mb-3">Review (132)</h2>
          <p>
            This bakery has received rave reviews from customers. With an average rating of 4.8 stars, patrons love the freshness, taste, and variety of our baked goods. Here's what some of our customers have to say:
          </p>
